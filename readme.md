...
3. 有cmd-wrap时testdisk编译步骤 ，```-O2 -g``` --> ```-O0 -g1``` [cmd-wrap.git   v2.2.simpl](http://giteaz:3000/bal/cmd-wrap/releases/tag/v2.2.simpl)  , [cmd-wrap.git 7fc35](http://giteaz:3000/bal/cmd-wrap/commit/7fc355dd259b847f14b9b8db61d649d3ff3df3b6)
